...
def _make_font(size, bold=False):
    """Return a font that can render Unicode suit symbols on all platforms."""
    for name in ["segoeuisymbol", "segoeui", "arialunicodems", "arial"]:
        try:
            f = pygame.font.SysFont(name, size, bold=bold)
            # Test that suit symbols actually render (won't be blank boxes)
...
font       = _make_font(17, bold=True)
small_font = _make_font(12, bold=True)
big_font   = _make_font(30, bold=True)
